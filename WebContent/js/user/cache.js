...
//                            '<div class="admin-header-lock-name" id="lockUserName">wind</div>'+
                            '<div class="input_btn">'+
    ...
    $("body").on("click","#unlock",function(){
        if($(this).siblings(".admin-header-lock-input").val() == ''){
        	...
        	var inputPassWord=$(this).siblings(".admin-header-lock-input").val();		//输入的密码
        	ajax("user/validPassWord",{passWord:inputPassWord},function(){
